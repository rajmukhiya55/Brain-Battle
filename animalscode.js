...
const AnimalsCode = ({ template, setSelectedTemplate }) => {
  ...
  const handleSubmitQuiz = () => {
    ...
    const existingQuizzes = JSON.parse(localStorage.getItem("animalsQuizzes")) || [];
    existingQuizzes.push(quizData);
    localStorage.setItem("animalsQuizzes", JSON.stringify(existingQuizzes));
