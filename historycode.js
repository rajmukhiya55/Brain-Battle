...
const HistoryCode = ({ template, setSelectedTemplate }) => {
  ...
  const handleSubmitQuiz = () => {
    ...
    const existingQuizzes = JSON.parse(localStorage.getItem("historyQuizzes")) || [];
    existingQuizzes.push(quizData);
    localStorage.setItem("historyQuizzes", JSON.stringify(existingQuizzes));
