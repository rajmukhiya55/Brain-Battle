...
const GeneralknowledgeCode = ({ template, setSelectedTemplate }) => {
  ...
  const handleSubmitQuiz = () => {
    ...
    const existingQuizzes = JSON.parse(localStorage.getItem("generalKnowledgeQuizzes")) || [];
    existingQuizzes.push(quizData);
    localStorage.setItem("generalKnowledgeQuizzes", JSON.stringify(existingQuizzes));
    ...
    <div className="container-fluid p-3 quiz-container">
      ...
      >
        <h3 className="fw-bold text-white text-center mb-3 template-heading">
          CREATE YOUR GENERAL KNOWLEDGE QUIZ
        </h3>
...
export default GeneralknowledgeCode;
