...
const GeographyCode = ({ template, setSelectedTemplate }) => {
  ...
  const handleSubmitQuiz = () => {
    ...
    const existingQuizzes = JSON.parse(localStorage.getItem("geographyQuizzes")) || [];
    existingQuizzes.push(quizData);
    localStorage.setItem("geographyQuizzes", JSON.stringify(existingQuizzes));
