...
const ScienceCode = ({ template, setSelectedTemplate }) => {
  ...
  const handleSubmitQuiz = () => {
    ...
    const existingQuizzes = JSON.parse(localStorage.getItem("scienceQuizzes")) || [];
    existingQuizzes.push(quizData);
    localStorage.setItem("scienceQuizzes", JSON.stringify(existingQuizzes));
